...
## Project Structure
    ...
    ├── testapiautosetting_126350  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_126350`
...
2. Clone this repo and `cd testapiautosetting_126350`
